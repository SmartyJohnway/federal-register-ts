 ...
 */
import type { DocumentField, PublicInspectionField, AgencyField, TopicField, IsoDateString } from "../request/types";
...
export type SearchResultEnvelope<T> = SearchMetadataEnvelope | NonEmptySearchResultEnvelope<T>;
...
export type PublicInspectionIssueDocumentsEnvelope<T> = ExistingPublicInspectionIssueDocumentsEnvelope<T> | MissingPublicInspectionIssueDocumentsEnvelope;
...
export type DocumentTypeName = "Rule" | "Proposed Rule" | "Notice" | "Presidential Document" | "Correction" | "Uncategorized Document" | "Sunshine Act Document";
export type PresidentialDocumentSubtype = "Determination" | "Executive Order" | "Memorandum" | "Notice" | "Proclamation" | "Presidential Order" | "Other";
...
export type DocumentSearchDefaultField = "title" | "type" | "abstract" | "document_number" | "html_url" | "pdf_url" | "public_inspection_pdf_url" | "publication_date" | "agencies" | "excerpts";
export type DocumentShowDefaultField = Exclude<DocumentField, "explanation" | "not_received_for_publication" | "page_views" | "regulation_id_number_info">;
...
export type PublicInspectionProjection<K extends PublicInspectionField = PublicInspectionField> = Pick<PublicInspectionFieldMap, K>;
export type PublicInspectionSearchItem<K extends PublicInspectionField = PublicInspectionField> = PublicInspectionProjection<K>;
export type PublicInspectionShowDefaultField = Exclude<PublicInspectionField, "json_url" | "excerpts">;
export type PublicInspectionShow<K extends PublicInspectionField = PublicInspectionShowDefaultField> = PublicInspectionProjection<K>;
export type PublicInspectionIssueItem<K extends PublicInspectionField = PublicInspectionField> = PublicInspectionProjection<K>;
...
export type PublicInspectionAgencyIdFacetMap = Record<string, FacetEntry>;
export type PublicInspectionAgencySlugFacetMap = Record<string, FacetEntry>;
...
export type PublicInspectionIssueDailyFacetMap = Record<IsoDateString, PublicInspectionIssueDailyBucket>;
export interface PublicInspectionIssueTypeEntry {
    readonly count: number;
    readonly name: string;
}
export type PublicInspectionIssueTypeGroup = Record<string, PublicInspectionIssueTypeEntry>;
...
export type PublicInspectionIssueTypeFacetMap = Record<IsoDateString, PublicInspectionIssueTypeBucket>;
...
export type TopicProjection<K extends TopicField = TopicField> = Pick<TopicFieldMap, K>;
/**
...
export type SuggestedSearchIndexMap = Record<string, readonly SuggestedSearchIndexItem[]>;
export type HolidayMap = Record<string, string>;
export type EffectiveDateDelayKey = "15" | "21" | "30" | "35" | "45" | "60" | "90";
export interface EffectiveDateOutcome {
    readonly date: IsoDateString;
    readonly delay_reasons: readonly string[];
}
export type EffectiveDateSchedule = Record<EffectiveDateDelayKey, EffectiveDateOutcome>;
